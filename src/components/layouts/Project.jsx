          ...
          <div className="md:w-full    px-8 pt-8 md:pb-[140px] rounded-[5px]">
            <Flex className="justify-between gap-y-5 flex-col md:flex-row">
              <div className="md:w-[40%] relative overflow-hidden group">
                ...
                <div className="w-full h-full bg-black/70 absolute    group-hover:top-0 top-[100%] left-0 flex items-center justify-center gap-x-5">
                  {" "}
                </div>
                <div className="w-full h-full  absolute duration-500   group-hover:top-0 top-[100%] left-0 flex items-center justify-center gap-x-5">
                  <p className="font-dm font-medium text-white text-lg ">
                    <Link to="https://github.com/thehasandev/ChatCraft.git">
                      View Code
                    </Link>
                  </p>
                  <p className="font-dm font-medium text-white text-lg ">
                    <Link to="https://chating-application-zeta.vercel.app/">
                      Live Project
                    </Link>
                  </p>
                </div>
              ...
              <div className="md:w-[55%] md:text-left text-center">
                <h2
                  className={`font-dm font-bold mb-2 md:mb-0  text-[20px] text-secondary`}
                >
                  Chating Application
                </h2>
                <p
                  className={`font-dm font-normal md:font-normal text-sm md:text-base mt-5  mx-auto text-center md:text-left md:pl-0 md:mx-0 w-8/12 text-secondary`}
                >
                  Website where you can get famous citation APIs collected by
                  different RestApis and create your own citations by setting by
                  your personal preferences.
                </p>

                <div className="hidden md:block">
                  <p className="mt-10 hidden md:block font-dm font-semibold font-lg text-secondary mb-5">
                    Use is Project :
                  </p>
                  ...
                  <Flex className="justify-center items-center gap-x-4 pt-8 ">
                    <Link to="https://github.com/thehasandev/ChatCraft.git">
                      <Flex className="items-center gap-x-2">
                        <p
                          className={`font-dm font-medium font-base  text-secondary`}
                        >
                          Code
                        </p>
