...
function Project() {
    const settings = {
        ...
        slidesToScroll: 1,
        autoplay:true,
        prevArrow:<PrevArrow class=" bottom-10 right-1/2"/>,
        nextArrow:<NextArrow class ="bottom-10 left-1/2"/>        
  ...
  return (
    <section className='mt-[120px] relative'>
        ...
        <Slider {...settings}>
          <div>
             <div className='w-full  bg-white shadow-xl shadow-gray-400/20  px-8 pt-8 pb-[140px] rounded-[5px]'>
                <Flex className="justify-between">
                   ...
                   <div className='w-[55%]'>
                   <h2 className='font-dm font-bold text-primary text-[20px]'>Orebi Ecommarce</h2> 
                    <p className='font-dm font-medium font-base text-secondary w-8/12'>
                    ...
                    <p className='mt-10 font-dm font-semibold font-lg text-secondary mb-5'>Use is Project :</p>
          ...
          <div>
            <div className='w-full   bg-white shadow-xl shadow-gray-400/20  px-8 pt-8 pb-[170px] rounded-[5px]'>
                <Flex className="justify-between">
                <div className='w-[35%] relative overflow-hidden group'>
                   ...
                   <div className='w-[55%]'>
                    <h2 className='font-dm font-bold text-primary text-[20px]'>Daraz Ecommarce</h2> 
                        <p className='font-dm font-medium font-base text-secondary w-8/12'>
                        Website where you can get famous citation APIs collected by different RestApis and create your own citations by setting by your personal preferences.
                        </p>
          ...
          <div>
            <div className='w-full  bg-white shadow-xl shadow-gray-400/20 px-8 pt-8 pb-[170px] rounded-[5px]'>
                ...
                <div className='w-[35%] relative overflow-hidden group'>
                   ...
                   <div className='w-[55%]'>
                    <h2 className='font-dm font-bold text-primary text-[20px]'>Security Guard Website</h2> 
                        <p className='font-dm font-medium font-base text-secondary w-8/12'>
                        Website where you can get famous citation APIs collected by different RestApis and create your own citations by setting by your personal preferences.
                        </p>
