        ...
        <Flex className="justify-between flex-col md:flex-row px-4 xl:px-0 gap-y-10">
          <div className="md:w-[40%] ">
            ...
            >
              ...
              developer, I bring a strong foundation in HTML, CSS, and
              JavaScript, coupled with deep expertise in React.js. I can develop
              any Figma or PSD template into React.js, and it will be
              responsive. I develop using modern frameworks like Tailwind CSS to
              create visually stunning websites. Currently, I'm working with
              Node.js, MongoDB, and Express.js. Recently, I developed an
              e-commerce website named Daraz, which showcases my capabilities
              and sets me apart from others in the field
            </p>
