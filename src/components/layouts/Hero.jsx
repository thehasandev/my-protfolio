        ...
        <Container>
            <Flex className="flex-col-reverse gap-y-10 lg:flex-row justify-center items-center">
                <div className='md:w-[50%] md:mx-0 mx:auto '>
                    ...
                    <p className={`font-dm  my-5 md:w-[400px] w-[360px] mx-auto md:mx-0 px-4 xl:px-0 text-sm md:text-lg ${darkData ? "text-white font-light" : "text-secondary font-medium"}`}>As a frontend developer, I bring a strong foundation in HTML, CSS, and JavaScript, coupled with deep expertise in React.js</p>
                    
                    <Flex className="md:w-[360px] justify-between">
                    <Link to='https://github.com/thehasandev'>
                        <div className={`duration-300 w-[110px] px-2 rounded-[2px] py-2 flex items-center justify-center gap-x-2 ${darkData ? "bg-white hover:bg-white" : "bg-primary hover:bg-secondary"}`}>
