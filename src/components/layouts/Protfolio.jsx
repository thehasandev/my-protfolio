                  ...
                  <div key={index}>
                    <div className="w-[350px] group scale-105 group overflow-hidden relative rounded-[10px]">
                      <Link
                        to={
                          title == "avada"
                            ? "https://hasan-adava.netlify.app"
                            : title == "discover"
                            ? "https://hasan-natural.netlify.app"
                            : title == "omah"
                            ? "https://omah-website.netlify.app"
                            : title == "creative"
                            ? "https://thehasandev.github.io/creativeit/"
                            : title == "innovate"
                            ? "https://react-multiple-pages-website.netlify.app"
                            : title == "charger"
                            ? "https://hasan-charger.netlify.app"
                            : title == "daraz"
                            ? "https://daraz-ecommarce.netlify.app"
                            : title == "Orabai"
                            ? "https://ecommerce-orebi.netlify.app/"
                            : title == "eduford"
                            ? "https://college-htmlcss.netlify.app"
                            : title == "waxom"
                            ? "https://waxxom.netlify.app"
                            : title == "you tube"
                            ? "https://dashing-clafoutis-ca5a45.netlify.app"
                            : title == "sequrity"
                            ? "https://bangel-force.netlify.app"
                            : title == "todo"
                            ? "https://react-facebook-todo.netlify.app"
                            : title == "game"
                            ? "https://react-game-twoplayers.netlify.app"
                            : title == "table search"
                            ? "https://table-search-react.netlify.app"
                            : title == "gameFirebase"
                      ...
                      <Link
                        to={
                          title == "avada"
                            ...
                            ? "https://dashing-clafoutis-ca5a45.netlify.app"
                            : title == "sequrity"
                            ? "https://security-gurd.netlify.app"
                            : title == "todo"
                            ? "https://react-facebook-todo.netlify.app"
                            : title == "game"
                            ? "https://react-game-twoplayers.netlify.app"
